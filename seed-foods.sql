...
select c.chat_id, v.* from c, (values
  ...
  ('מק דאבל', ARRAY['מקדונלדס דאבל','דאבל','מק-דאבל','דאבל צ''יזבורגר']::text[], 'McDonald''s מק דאבל', null, null, null, null, null),
...
from (values
  ('מק דאבל', '{"kcal":272,"protein":22,"carbs":25.2,"fat":9.6,"unit":"מנה"}'::jsonb),
