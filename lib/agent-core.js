...
// The AI-button brain: a small cheap model with a small prompt. The button
// exists to decode odd phrasings — confirmation + undo guard its output.
const LITE_MODEL = process.env.AGENT_LITE_MODEL || 'claude-haiku-4-5';
...
// logged meal. No web search (not supported on the small model's tool variant).
